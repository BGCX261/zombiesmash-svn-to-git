...
namespace GameStateManagement.Util
{
    class Utils
    {
        ...
        public static void DrawModel(Model model, Matrix world, Camera camera)
        {
                                       ...
                                       float currentAngle, float turnSpeed)
        {
            ...
            float desiredAngle = (float)(Math.Atan2(dif.Y, dif.X) * 180.0f / Math.PI);
